...
class DivisionFuncion { // Nombre de la clase
    public static void main(String[] args) { // Metodo principal
        ...
        System.out.println("Dame 2 numeros para dividir: "); // Le pedimos 2 numeros al usuario para realizar la
                                                             // division
    ...
    public static void division(double n1, double n2) { // Definimos una funcion estatica llamada suma que toma dos
                                                        // enteros como parametros
        // Colocamos una validacion que verifique que los 2 numeros dados por el usuario
        // sean numeros enteros y en caso de que el segundo numero sea 0 mandara un
        // mensaje de error
        if (n2 != 0) {
